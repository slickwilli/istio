...
// IPV4Prefix = features.IPAutoAllocateIPv4CIDR
// IPV6Prefix = features.IPAutoAllocateIPv6CIDR
)
...
func NewIPAllocator(stop <-chan struct{}, c kubelib.Client) *IPAllocator {
	...
	allocator := &IPAllocator{
		...
		v4allocator: newPrefixUse(netip.MustParsePrefix(features.IPAutoAllocateIPv4CIDR)),
		v6allocator: newPrefixUse(netip.MustParsePrefix(features.IPAutoAllocateIPv6CIDR)),
	}
